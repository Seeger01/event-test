...
<body>
	<div class="topbar navbar fixed-top ">
		...
		<div class="d-flex justify-content-lg-end">
			<div class="p-2"><button class="p2">Få Tilbud</button>
			</div>
		</div>
	...
	<nav class=" navstyle navbar navbar-expand-lg navbar-light">
		...
		<div class="container">
			<a class="navbar-brand" href="index.html"><img src="img/logo_2.png" alt="logo"></a>
        ...
        <br> -->
			...
			<div id="accordion" role="tablist">
                ...
                Musik
					...
					<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
						<div class="card-body">
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck7" name='speakers' onclick="value='true'">
                    ...
                    1 - Højtalere 
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck2" name='lys' onclick="value='true'">
                    ...
                    Lys 
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck3" name='sspeakers' onclick="value='true'">
                    ...
                    2 - Højtalere 
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck4" name='soundboks' onclick="value='true'">
                    ...
                    Soundboks
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck5" name='anleg' onclick="value='true'">
                    ...
                    Fuldt anlæg med Top-bund system
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck6" name="dj" onclick="value='true'">
                  ...
                  Underholdning
					...
					<div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
						<div class="card-body">
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck8" name="beerpong" onclick="value='true'">
                    ...
                    Beerpong
							...
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="defaultCheck9" name="stodband" onclick="value='true'">
			...
			<div class="row">
				<div class="col-lg">
					...
					<input class="form-control" name="dato" type="date">
				</div>
				<div class="col-lg">
					<h6 class="my-1">Tid</h6>
					<input class="form-control" name="tid" type="time">
				</div>
				<div class="col-lg">
					<h6 class="my-1">Antal gæster</h6>
					<input class="form-control" name="antal" type="text" value="">
				</div>
			</div>
			<br>
			...
			<div class="row mb-4">
				...
				<div class="col-md-4">
					<input class="btn2 btn btn-lg btn-secondary btn-block" type="submit" value="BESTIL TILBUD NU">
				</div>
			</div>
			<hr>
		</div>
